...
- <span style="background-color: #FFFFFF; padding: 0.2em; border-radius: 4px; word-wrap: overflow-wrap: word-break: break-all;">**End-to-End Lyric-to-Melody Generation via Chord Integration and Bar-Level Modeling.** <a href="[End-to-End Lyric-to-Melody Generation via Chord Integration and Bar-Level Modeling](https://spike233666.github.io/CBL2M_html/)" style="color:#3399FF;">[project]</a></span><br><span style="font-size: 0.9em;">Ke Gu, Peng Bai, Zhen Lei, Yue Zhou, **Zhicong Wu**, Xiaodong Shi.</span><br><span style="font-size: 0.9em;">*IEEE International Conference on Multimedia&Expo (ICME) - 2025*</span>
